...
NSHCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as NSHCoin Core, where everyone uses
...
pay attention to for reviewers of NSHCoin Core code.

General NSHCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: NSHCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
