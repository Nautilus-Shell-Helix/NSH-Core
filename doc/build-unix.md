UNIX BUILD NOTES
====================
Some notes on how to build NSHCoin Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Note
---------------------
Always use absolute paths to configure and compile NSHCoin Core and the dependencies,
...
This will build nshc-qt as well if the dependencies are met.
...
# Configure NSHCoin Core to use our own-built instance of BDB
cd $Stim_ROOT
./autogen.sh
...
Security
--------
To help make your NSHCoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, NSHCoin Core should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, NSHCoin Core may be compiled in
