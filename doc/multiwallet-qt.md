...
Only requiring some minor changes is nshc.cpp.
...
Changes to nshc.cpp
----------------------
nshc.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
