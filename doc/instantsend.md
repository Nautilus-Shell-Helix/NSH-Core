...
This mechanism has been integrated into Bitcore-Node-NSHCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nshccoin/insight-api-nshc#web-socket-api](https://github.com/nshccoin/insight-api-nshc#web-socket-api) 
* API: [https://github.com/nshccoin/insight-api-nshc#instantsend-transactions](https://github.com/nshccoin/insight-api-nshc#instantsend-transactions) 
...
By default, the NSHCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NSHCoin Core daemon:
