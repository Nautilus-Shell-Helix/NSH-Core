...
{
    if(fLiteMode) return; // ignore all NSHCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat NSHCoin and make it unusable. To
