...
/**
 * NSHCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue enshcatefee(const UniValue& params, bool fHelp);
extern UniValue enshcatepriority(const UniValue& params, bool fHelp);
extern UniValue enshcatesmartfee(const UniValue& params, bool fHelp);
extern UniValue enshcatesmartpriority(const UniValue& params, bool fHelp);
