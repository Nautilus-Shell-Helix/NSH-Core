    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("NSHCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NSHCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nshc: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About NSHCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about NSHCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NSHCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NSHCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NSHCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a nshc: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NSHCoin Core help message to get a list with possible NSHCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("NSHCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NSHCoin network", "", count));
}
...
{
    QString strTitle = tr("NSHCoin Core"); // default title
