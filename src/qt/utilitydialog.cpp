    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("NSHCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About NSHCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  nshc-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the NSHCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NSHC, 0.1 NSHC, 1 NSHC and 10 NSHC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://nshcco.in/privatesend/\">https://nshcco.in/privatesend/</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("NSHCoin Core is shutting down...") + "<br /><br />" +
