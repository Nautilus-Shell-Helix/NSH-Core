...
2. run nshcd with -printalert or -sendalert like this:
   /path/to/nshcd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.nshc.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/NSHCoin Core:0.12.0.58/"));
